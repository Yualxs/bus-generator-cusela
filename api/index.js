...
export default async function handler(req, res) {
  try {
    ...
    // --- NUEVO: LÓGICA DE LA FECHA Y HORA ---
    const now = new Date();
    ...
    <svg width="300" height="50">
      <text x="5" y="20" font-family="Arial, sans-serif" font-size="12" fill="#444">
    ...
    // --- NUEVO: Añadimos el texto a la composición ---
    composites.push({
      input: svgBuffer,
      top: 680, // Puedes ajustar la posición Y
      left: 10   // Puedes ajustar la posición X
    });
    // -----------------------------------------
